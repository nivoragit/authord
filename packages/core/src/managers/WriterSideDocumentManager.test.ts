...
describe('WriterSideDocumentManager', () => {
    ...
    describe('createDocument', () => {
        it('should create a new document and update ihpData', async () => {
            ...
            expect(FileService.writeNewFile).toHaveBeenCalledTimes(2)
            expect(manager.getInstances()[0].id).toBe('new-doc');
        });
    });
    ...
    describe('removeDocument', () => {
        ...
        it('should return false if document is not found', async () => {
            ...
            (manager as any)['instances'] = [{ id: 'other-doc' } as InstanceProfile];
