...
var AbstractFileService = /** @class */ (function () {
    function AbstractFileService() {
    }
    AbstractFileService.parseXmlString = function (xmlText) {
        var parser = new fast_xml_parser_1.XMLParser({ ignoreAttributes: false });
        return parser.parse(xmlText);
    };
    AbstractFileService.buildXmlString = function (xmlData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, builder.build(xmlData)];
            });
        });
    };
