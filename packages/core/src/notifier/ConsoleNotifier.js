...
var ConsoleNotifier = /** @class */ (function () {
    ...
    ConsoleNotifier.prototype.showErrorMessage = function (message) {
    ...
    ConsoleNotifier.prototype.showWarningMessage = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    ConsoleNotifier.prototype.showInformationMessage = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
